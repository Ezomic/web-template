...
final class IdPortalClient
{
    ...
    private function token(): ?string
    {
        ...
        $response = Http::acceptJson()->asForm()->post($this->url('/oauth/token'), [
            ...
            'client_id' => Config::string('services.thijssensoftware.client_id'),
            'client_secret' => Config::string('services.thijssensoftware.client_secret'),
        ]);
    ...
    {
        return filled(Config::get('services.thijssensoftware.base_url'))
            && filled(Config::get('services.thijssensoftware.client_id'))
            && filled(Config::get('services.thijssensoftware.client_secret'));
    }
